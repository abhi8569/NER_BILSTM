...
parameters['test'] = "./data/w-nut/emerging.test.annotated" #Path to dev file
...
mapping_file = './data/mapping_wnut.pkl'
...
def forward_alg(self, feats):
    ...
    # Do the forward algorithm to compute the partition function (normalization factor in order to get a probability at the end.)
    init_alphas = torch.Tensor(1, self.tagset_size).fill_(-10000.)

    #init_alphas = self.transitions[:, self.tag_to_ix[START_TAG]].view(1,-1) + feats[0,:].view(1,-1)
